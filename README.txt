...
This will build the react application and then start the node server.

You can view the finished application here (https://infinite-reef-31320.herokuapp.com/).
